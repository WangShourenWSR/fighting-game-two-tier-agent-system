...
REWARD_KWARGS = {
    ...
    'special_move_bonus': 0.0, # Bonus for dealing damage with special moves. The raw reward will be multiplied by this value, so set it to 1.0 if you don't want to use this feature.
    'projectile_reward': 20.0, # Reward for using projectiles
    'projectile_bonus': 0.0, # Bonus for dealing damage with projectiles. The raw reward will be multiplied by this value, so set it to 1.0 if you don't want to use this feature.
    'distance_reward': 0.1, # Set it to positive value to encourage the agent to stay far from the enemy, negative value to encourage the agent to stay close to the enemy
    ...
    'in_air_reward': 0.0, # Reward for being in the air
    'time_reward_bonus': 0.05, # Bonus for the duration of the round. Set it to positive value to encourage the agent to stay longer in the round, negative value to encourage the agent to finish the round quickly
    'cost_coef': 3.0, # Ratio between the cost and the reward
    'special_move_cost': 10.0,
    'regular_attack_cost': 2.0,
    'jump_cost': 10.0,
