...
REWARD_KWARGS = {
    ...
    'time_reward_bonus': 0.00, # Bonus for the duration of the round. Set it to positive value to encourage the agent to stay longer in the round, negative value to encourage the agent to finish the round quickly
    'cost_coef': 3.0, # Ratio between the cost and the reward
    'special_move_cost': 5.0,
